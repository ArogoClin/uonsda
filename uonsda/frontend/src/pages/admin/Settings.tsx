...
export default function Settings() {
  ...
  const [activeTab, setActiveTab] = useState<'profile' | 'admins' | 'security' | 'locations'>('profile');
        ...
        <div className="bg-white rounded-xl shadow-md mb-6">
          <div className="border-b border-gray-200">
            <nav className="flex -mb-px">
              ...
              {/* Locations Tab - Available for both CLERK and ELDER */}
              <button
          ...
          <div className="p-6">
              ...
              <div className="max-w-2xl">
                ...
                <form onSubmit={changePassword} className="space-y-6">
                  ...
                  <button
                    ...
                    className="px-6 py-3 bg-gradient-to-r from-teal-600 to-blue-600 text-white rounded-lg hover:from-teal-700 hover:to-blue-700 transition-all font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
                  >
                    {isChangingPassword ? (
                      <>
            ...
            {/* Locations Tab - Both CLERK and ELDER can access */}
            {activeTab === 'locations' && (
              <LocationManagement />
            )}

            {/* Admin Management Tab (ELDER Only) */}
      ...
      {showNewAdminModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl p-8 max-w-2xl w-full mx-4">
            ...
            <form onSubmit={createNewAdmin} className="space-y-6">
